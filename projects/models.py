...
class Project(models.Model):
    ...
    img1 = models.ImageField(upload_to='projects/%Y/%m/%d/', blank=True, null=True)
    img2 = models.ImageField(upload_to='projects/%Y/%m/%d/', blank=True, null=True)
    img3 = models.ImageField(upload_to='projects/%Y/%m/%d/', blank=True, null=True)
    img4 = models.ImageField(upload_to='projects/%Y/%m/%d/', blank=True, null=True)
    img5 = models.ImageField(upload_to='projects/%Y/%m/%d/', blank=True, null=True)
