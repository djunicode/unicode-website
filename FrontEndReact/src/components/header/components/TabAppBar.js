    ...
    handleChange = (event, value) => {
      ...
      componentDidUpdate(prevProps,prevState){
          if(prevProps!=this.props){
              this.setState({value: Number(this.props.headerValue)})
          }
      }
        ...
        return ( 
            ...
            <AppBar 
                ...
                <Toolbar >
                    ...
                    <a href="/"><img src="http://bagwesagar6699.pythonanywhere.com//static/frontend/55dddef0a88a68002e8b6ee957ee02c2.PNG" alt="logo" width="237px" style={{marginLeft: "8%"}} /></a>
