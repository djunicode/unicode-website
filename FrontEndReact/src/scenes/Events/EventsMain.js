...
class MyApp extends Component {
  ...
  getData=()=>{
    axios.get("http://bagwesagar6699.pythonanywhere.com//api/events/")
    .then(response=>{
        ...
        <Grid container direction="row" justify="center">
          <Grid item xs={12}>
            ...
            <MediaQuery maxWidth={768} >
              <img
                  src="http://bagwesagar6699.pythonanywhere.com//static/frontend/568640b8bf2f641847ef3258546e2ea0.png"
                  alt={""}
