...
class HomePage extends Component {
    state = { 
        ...
        fData:[{
                ...
                img: 'https://storage.googleapis.com/unicode-data/static/frontend/fd739a5ad72a675a23001228a8472bee.PNG'
            },
            {
                name: 'Swapneel Mehta',
                ...
                position: '',
                img: 'https://storage.googleapis.com/unicode-data/static/frontend/52de6bcc084de48b3f8d72f79ba5be13.jpg'
            },
            {
                ...
                position: '',
                img: 'https://storage.googleapis.com/unicode-data/static/frontend/486f20358766b426e5bef4f452ae867f.jpg'
            },
            {
                ...
                position: '',
                img: 'https://storage.googleapis.com/unicode-data/static/frontend/b9f0c5dfd072f4a11c8fef1fd3423d9f.jpeg'
            }
        ]
     }
     styles={
                            ...
                            >
                                ...
                                <MediaQuery maxWidth={1179} >
                                    <Grid item xs={12} style={{paddingTop: 10}} >
                                        ...
                                        >
                                            <Grid item xs={4} >
                                                <Avatar onClick={()=>{this.open(1)}} style={this.styles.founder} src="https://storage.googleapis.com/unicode-data/static/frontend/fd739a5ad72a675a23001228a8472bee.PNG"/>
                                            </Grid>
                                            <Grid item xs={4} >
                                                <Avatar onClick={()=>{this.open(2)}} style={this.styles.founder} src="https://storage.googleapis.com/unicode-data/static/frontend/52de6bcc084de48b3f8d72f79ba5be13.jpg"/>
                                            </Grid>
                                            <Grid item xs={4} >
                                                <Avatar onClick={()=>{this.open(3)}} style={this.styles.founder} src="https://storage.googleapis.com/unicode-data/static/frontend/486f20358766b426e5bef4f452ae867f.jpg"/>
                                            </Grid>
                                            {/* <Grid item xs={4} >
                                                <Avatar onClick={()=>{this.open(1)}} style={this.styles.founder} src="https://storage.googleapis.com/unicode-data/static/frontend/fd739a5ad72a675a23001228a8472bee.PNG"/>
                                            </Grid> */}
                                            <Grid item xs={4} >
                                                <Avatar onClick={()=>{this.open(4)}} style={this.styles.founder} src="https://storage.googleapis.com/unicode-data/static/frontend/b9f0c5dfd072f4a11c8fef1fd3423d9f.jpeg"/>
                                            </Grid>
                                        </Grid>
                                    </Grid>
                                </MediaQuery>
