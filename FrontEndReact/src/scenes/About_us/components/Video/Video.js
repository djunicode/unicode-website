    ...
    render() { 
        return ( 
            ...
            <header class="v-header containerVideo">
                ...
                {/* <img src="http://bagwesagar6699.pythonanywhere.com//static/frontend/417f9c3f8b4915bb2c996ef1f82b48ca.png" alt="about_us" style={{objectFit: 'cover',height: '100%', width: '100%'}} /> */}
                <img src='http://bagwesagar6699.pythonanywhere.com//static/frontend/417f9c3f8b4915bb2c996ef1f82b48ca.png' alt="about_us" style={{objectFit: 'cover',height: '100%', width: '100%'}} />
                </div>
